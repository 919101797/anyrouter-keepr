...
const badgeVariants = cva(
  "inline-flex h-6 min-w-max shrink-0 flex-nowrap items-center gap-1.5 whitespace-nowrap rounded-[6px] px-2.5 text-xs font-semibold leading-none [&>svg]:h-3.5 [&>svg]:w-3.5 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
